...
class RSVPForm extends React.Component {
  ...
  submit = () => {
    ...
    this.setState({submitting: true}, () =>
      axios.post(`${window.location.protocol}//${window.location.hostname}:8080/api/saveRSVP`, this.state)
  ...
  handleRSVPChange = (rsvpCode) =>
    this.setState({rsvpCode}, () => {
      axios.post(`${window.location.protocol}//${window.location.hostname}:8080/api/getGuestCount`, {rsvpCode})
